...
def main(input_files):
	...
	for file in tqdm.tqdm(input_files):
		corresponding_file_manuscript = file.replace(".xml", ".manuscript_line_only.xml")
		print(file)
		if ".manuscript_line_only.xml" in file or os.path.isfile(corresponding_file_manuscript):
		...
		try:
			...
			continue
		print(corresponding_file_manuscript)
		try:
		...
		with open(corresponding_file_manuscript, "w") as f:
