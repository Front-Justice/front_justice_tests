...
def check_minute_consistency(minute_list, ident):
	...
	if classes == [1, 2, 3, 4]:
		...
		if len(minute_list) > 4:
			minute_list = [{**minute, "classe": "page_autre"} for minute in minute_list[2:-2]]
...
def main(images_dir:str,
	...
	with open("src/Information_Extractor/databases/correspondance_armees_minute.json", "r") as correspondance:
		correspondance_minutiers = json.load(correspondance)
